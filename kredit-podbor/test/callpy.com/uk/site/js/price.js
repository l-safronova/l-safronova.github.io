$(function() {
    ...
    function getSumm() {
        ...
        if (month_of == 1) text_month_of = month_of + ' '+"місяць";
        else if (month_of == 3) text_month_of = month_of + ' '+"місяці";
        else {
            text_month_of = month_of + ' '+"місяців";
        }

        if (consultant == 1) text_consultant = consultant + ' '+"консультант";
        else if (consultant == 3) text_consultant = consultant + ' '+"консультанта";
        else text_consultant = consultant + ' '+"консультантів";
