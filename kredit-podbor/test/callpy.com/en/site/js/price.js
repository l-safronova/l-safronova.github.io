$(function() {
    ...
    function getSumm() {
        ...
        if (month_of == 1) text_month_of = month_of + ' '+"month";
        else if (month_of == 3) text_month_of = month_of + ' '+"month";
        else {
            text_month_of = month_of + ' '+"month";
        }

        if (consultant == 1) text_consultant = consultant + ' '+"consultant";
        else if (consultant == 3) text_consultant = consultant + ' '+"consultants";
        else text_consultant = consultant + ' '+"consultants";
