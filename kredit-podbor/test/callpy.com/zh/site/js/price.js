$(function() {
    ...
    function getSumm() {
        ...
        if (month_of == 1) text_month_of = month_of + ' '+"月";
        else if (month_of == 3) text_month_of = month_of + ' '+"月";
        else {
            text_month_of = month_of + ' '+"月";
        }

        if (consultant == 1) text_consultant = consultant + ' '+"顾问";
        else if (consultant == 3) text_consultant = consultant + ' '+"顾问";
        else text_consultant = consultant + ' '+"顾问";
