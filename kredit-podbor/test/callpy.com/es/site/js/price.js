$(function() {
    ...
    function getSumm() {
        ...
        if (month_of == 1) text_month_of = month_of + ' '+"mes";
        else if (month_of == 3) text_month_of = month_of + ' '+"meses";
        else {
            text_month_of = month_of + ' '+"meses";
        }

        if (consultant == 1) text_consultant = consultant + ' '+"consultante";
        else if (consultant == 3) text_consultant = consultant + ' '+"consultantes";
        else text_consultant = consultant + ' '+"consultantes";
