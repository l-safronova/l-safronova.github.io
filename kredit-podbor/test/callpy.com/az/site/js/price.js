$(function() {
    ...
    function getSumm() {
        ...
        if (month_of == 1) text_month_of = month_of + ' '+"месяц";
        else if (month_of == 3) text_month_of = month_of + ' '+"месяца";
        else {
            text_month_of = month_of + ' '+"месяцев";
        }

        if (consultant == 1) text_consultant = consultant + ' '+"консультант";
        else if (consultant == 3) text_consultant = consultant + ' '+"консультанта";
        else text_consultant = consultant + ' '+"консультантов";
